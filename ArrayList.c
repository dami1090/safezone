...
ArrayList* al_clone(ArrayList* this)
{
    ...
    if(this!=NULL)
    {
        ...
        if(lista!=NULL)
        {
            for(i=0; i<this->len(this); i++)
            {
                dato=(void**)this->get(this,i);
                lista->add(lista,dato);
            }
            returnAux=lista;
        }
    }
...
ArrayList* al_subList(ArrayList* this,int from,int to)
{
    ...
    void* aux;
    ArrayList* lista;
    if(this!=NULL && from>=0 && from<this->len(this) && from<to && to<=this->len(this) && to>0)
    {
        lista=al_newArrayList();
        if(lista!=NULL)
        {
...
int al_containsAll(ArrayList* this,ArrayList* this2)
{
    ...
    if(this!=NULL && this2!=NULL)
    {
        ...
        {
            aux=this2->get(this2,i);
            auxCon=this2->contains(this,aux);
            if(auxCon!=1)
            {
                flag=1;
                break;
...
int al_sort(ArrayList* this, int (*pFunc)(void*,void*), int order)
{
    ...
    if(this!=NULL && pFunc!=NULL &&  (order==0 || order ==1))
    {
        for(i=0; i<this->len(this)-1; i++)
        {
            ...
            {
                auxFun= pFunc(this->get(this,i),this->get(this,j));
                if(order==1 && auxFun==1)
                {
                    aux=this->get(this,i);
                ...
                else if(order ==0 && auxFun == -1)
                {
                    aux=this->get(this,j);
                    this->set(this,j,this->get(this,i));
                    this->set(this,i,aux);
...
int contract(ArrayList* this,int index)
{
    ...
    if(this!=NULL && index>=0 && index<=this->len(this))
    {
        ...
        {
            pElement=this->get(this,i+1);
            this->set(this,i,pElement);
        }
...
/** \brief Deincrement the number of elements in pList in size+AL_INCREMENT elements.
* \param pList ArrayList* Pointer to arrayList
* \return int Return (-1) if Error [pList is NULL pointer or if can't allocate memory]
*                  - (0) if ok
*/
...
/** \brief
 * \param pList ArrayList* Pointer to arrayList
 * \param pFunc (*pFunc) Pointer to function to calcular sueldo
 * \return void* pointer of element complete
 *
 */
